...
# with command line options: --python_filename TSG-Run3Summer21DRPremix-00024_2_cfg.py --eventcontent RECOSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM-RECO --fileout file:TSG-Run3Summer21DRPremix-00024.root --conditions 120X_mcRun3_2021_realistic_v6 --step RAW2DIGI,L1Reco,RECO,RECOSIM --geometry DB:Extended --filein file:summer21Input.root --era Run3 --no_exec --mc -n 100
...
process.RECOSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:TSG-Run3Summer21DRPremix-00024_12X.root'),
