...
# with command line options: Configuration/GenProduction/python/HTo4tau_1000_450_10000_fragment.py --python_filename HTo4tau_1000_450_10000_fragment.py --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM --fileout file:TSG-Run3Summer21GS-00041.root --conditions 120X_mcRun3_2021_realistic_v5 --beamspot Run3RoundOptics25ns13TeVLowSigmaZ --customise_commands process.g4SimHits.Physics.G4GeneralProcess = cms.bool(False) --step GEN,SIM --geometry DB:Extended --era Run3 --no_exec --mc -n 100
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/HTo4tau_1000_450_10000_fragment.py nevts:100'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:TSG-Run3Summer21GS-00041.root'),
...
process.generator = cms.EDFilter("Pythia8ConcurrentGeneratorFilter",
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            '6000113:new = LL_tau LLbar_tau 1 0 0',
            '6000113:m0 = 450',
            '6000113:mWidth = 1.973269788e-17',
            '6000113:tau0 = 10000',
            '6000113:isResonance = on',
            '6000113:mayDecay = on',
            '6000113:oneChannel = 1 1.0 100 15 -15',
            '35:m0 = 1000',
            '35:mWidth = 27.0',
            '35:2:bRatio = 0.0',
            '35:3:bRatio = 0.0',
